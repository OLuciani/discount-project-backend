...
app.use((req, res, next) => {
    res.setHeader(
      ...
      "http://localhost:8081" // Reemplaza esto con la URL de tu frontend
    );
    res.setHeader(
    ...
    res.setHeader("Access-Control-Max-Age", 7200); // Duración máxima de la solicitud preflight en segundos
